...
export default function UsersMenu() {
  ...
  return (
    ...
    >
      ...
      <div className="p-1">
        <Link
          className="flex items-center space-x-2 w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
        ...
        >
          ...
          <span className="text-black dark:text-white">프로필</span>
        </Link>
      </div>
      <div className="p-1">
        <Link
        ...
        >
          ...
          <span className="text-black dark:text-white" >설정</span>
        </Link>
      </div>
      ...
      {isSubMenuOpen && (
        <div className="absolute right-full top-32 w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg">
